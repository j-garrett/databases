...
var app = {
  ...
  send: function(data) {
    ...
    app.$message.val('');
    console.log('__client/app.js L39 incoming data to POST request: ', data);
    ...
    $.ajax({
      ...
      success: function (data) {
        console.log('posted successfully from client side');
  ...
  fetch: function(animate) {
    $.ajax({
      ...
      success: function(data) {
        ...
        var displayedRoom = $('.chat span').first().data('roomname_id');
        app.stopSpinner();
